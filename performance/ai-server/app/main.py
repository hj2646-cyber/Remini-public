...
def safe_reply(message: str, session_id: str, user_id: str | None, channel: str = "chat") -> dict:
    ...
    if not should_show_memory_photo and _perf.reminiscence_photo_enabled():
        try:
...
def web_index() -> FileResponse:
    # 시연판: 검정 시절(1864a80~1) 의 patient-react 가 default — 자비스 + 검정 UI
...
def warmup_for_user(req: WarmupRequest) -> dict:
    ...
    1) **chat LLM** (gemma4:31b + wiki 22k) — KV 캐시 prefix prefill
